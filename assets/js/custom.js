...
(function( $ ){
	...
	$('#mu-event-counter').countdown('2018/01/28 17:00:00').on('update.countdown', function(event) {
	  var $this = $(this).html(event.strftime(''
	    + '<span class="mu-event-counter-block"><span>%D</span> Giorni</span> '
	    + '<span class="mu-event-counter-block"><span>%H</span> Ore</span> '
	    + '<span class="mu-event-counter-block"><span>%M</span> Minuti</span> '
	    + '<span class="mu-event-counter-block"><span>%S</span> Secondi</span>'));
	});
